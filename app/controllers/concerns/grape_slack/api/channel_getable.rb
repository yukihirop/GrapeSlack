  ...
  module Api
    module ChannelGetable
      ...
      def execute_channel_list_from_redis
        @list_from_redis ||= {}
        begin
          list_from_redis_with_timeout(@list_from_redis)
        rescue Timeout::Error
          list_from_redis_with_rescue(@list_from_redis)
        end
        @list_from_redis
      end

      def list_from_redis_with_timeout(list_from_redis)
        @list_from_redis = list_from_redis
      ...
      def list_from_redis_with_rescue(list_from_redis)
        @list_from_redis = list_from_redis
